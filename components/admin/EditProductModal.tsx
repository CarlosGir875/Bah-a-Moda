        ...
        <div className="overflow-y-auto w-full p-6 sm:p-10 hide-scrollbar">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div>
                    ...
                    {previews.length === 0 ? (
                    <label htmlFor="edit-upload-init" className="border-2 border-dashed border-gray-300 bg-gray-50 rounded-3xl w-full aspect-[4/5] flex flex-col items-center justify-center cursor-pointer hover:bg-gray-100 hover:border-gray-400 transition-all group relative overflow-hidden">
                        <input id="edit-upload-init" type="file" multiple accept="image/jpeg, image/png, image/webp, image/*" onChange={handleFileChange} className="hidden" />
                    ...
                    <div className="space-y-4">
                        ...
                        <label htmlFor="edit-upload-add" className="relative aspect-square border-2 border-dashed border-gray-200 rounded-2xl flex flex-col items-center justify-center cursor-pointer hover:bg-gray-50 transition-colors">
                            <input id="edit-upload-add" type="file" multiple accept="image/jpeg, image/png, image/webp, image/*" onChange={handleFileChange} className="hidden" />
