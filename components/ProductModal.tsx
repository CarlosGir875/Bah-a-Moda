...
export function ProductModal({ product, onClose }: ProductModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-2 sm:p-6 bg-black/90 backdrop-blur-md">
      ...
      {/* Modal Container — Vertical layout, max-w narrow, tall */}
      <motion.div
      ...
      >
        ...
        {/* ═══════════════════════════════════════
            IMAGE GALLERY — Full width, full image, no background
            ═══════════════════════════════════════ */}
            ...
            >
              {currentImage ? (
                ...
                <div className="aspect-video flex items-center justify-center">
                  <span className="text-gray-300 font-black text-sm uppercase tracking-widest">
                    Bahía Moda
                  </span>
                </div>
              )}
        ...
        <div className="px-6 pt-6 pb-8 flex flex-col gap-4">
          ...
          <div className="grid grid-cols-3 gap-4 pt-4 border-t border-gray-100">
            ...
            <div className="flex flex-col items-center text-center gap-2">
              ...
              <span className="text-[9px] font-black uppercase tracking-widest text-black leading-tight">
                Garantía<br /><span className="text-gray-400 font-bold">Original</span>
              </span>
            </div>
          </div>
        </div>
